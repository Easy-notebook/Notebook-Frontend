import { g as Ge } from './chunk-WVR4S24B-CyxjGwcS.js';
import { s as ze } from './chunk-NRVI72HA-BjLFR7Hg.js';
import {
  _ as m,
  j as Xe,
  i as Je,
  ...
  var e = m(function (P, i, r, l) {
    ...
    Se = {
      ...
      table: [
        ...
        e(y, [2, 57], { 76: Me }),
        e(y, [2, 58], { 76: U }),
        { 5: B, 28: 105, 31: Q, 34: H, 36: K, 38: j, 40: W },
        { 27: [1, 112], 76: U },
        ...
        { 32: [1, 124] },
        { 32: [1, 125] },
        { 5: B, 28: 126, 31: Q, 34: H, 36: K, 38: j, 40: W },
        e(y, [2, 28]),
        { 5: [1, 127] },
        e(y, [2, 42]),
        { 32: [1, 128] },
        ...
        e(y, [2, 27]),
        { 5: B, 28: 145, 31: Q, 34: H, 36: K, 38: j, 40: W },
        ...
        { 5: [2, 90] },
        e(y, [2, 43]),
        { 5: B, 28: 159, 31: Q, 34: H, 36: K, 38: j, 40: W },
        { 5: B, 28: 160, 31: Q, 34: H, 36: K, 38: j, 40: W },
        { 5: B, 28: 161, 31: Q, 34: H, 36: K, 38: j, 40: W },
        { 5: B, 28: 162, 31: Q, 34: H, 36: K, 38: j, 40: W },
      ...
      parse: m(function (i) {
        ...
        function Ue() {
          ...
          return (
            (T = s.pop() || S.lex() || $e),
            typeof T != 'number' &&
              (T instanceof Array && ((s = T), (T = s.pop())), (T = r.symbols_[T] || T)),
            T
          );
        }
        m(Ue, 'lex');
        for (var b, z, q, Te, J = {}, ge, F, Ye, _e; ; ) {
          if (
            ...
            this.defaultActions[z]
              ...
              : ((b === null || typeof b > 'u') && (b = Ue()), (q = Ee[z] && Ee[z][b])),
          ...
          switch (q[0]) {
            ...
            case 2:
              if (
                ...
                (Te = this.performAction.apply(J, [n, Pe, ye, G.yy, q[1], d, t].concat(Ke))),
                typeof Te < 'u')
              )
                return Te;
              (F &&
                ((l = l.slice(0, -1 * F * 2)), (d = d.slice(0, -1 * F)), (t = t.slice(0, -1 * F))),
...
` +
        ...
        next: m(function () {
          ...
          for (var d = this._currentRules(), t = 0; t < d.length; t++)
            if (
              ((l = this._input.match(this.rules[d[t]])), l && (!r || l[0].length > r[0].length))
            ) {
