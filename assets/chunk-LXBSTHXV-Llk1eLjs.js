import { g as te } from './chunk-WVR4S24B-CyxjGwcS.js';
import { s as ee } from './chunk-NRVI72HA-BjLFR7Hg.js';
import {
  _ as f,
  m as D,
  k as F,
...
Expecting ` +
          ...
          if (w[0] instanceof Array && w.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + H + ', token: ' + C
            );
          switch (w[0]) {
            case 1:
              (n.push(C),
            ...
            case 2:
              if (
                ...
                Qt && (J._$.range = [r[r.length - (G || 1)].range[0], r[r.length - 1].range[1]]),
                (mt = this.performAction.apply(J, [c, X, U, j.yy, w[1], E, r].concat(Tt))),
                typeof mt < 'u')
              )
                return mt;
              (G &&
                ((n = n.slice(0, -1 * G * 2)), (E = E.slice(0, -1 * G)), (r = r.slice(0, -1 * G))),
...
` +
        ...
        next: f(function () {
          ...
          for (var E = this._currentRules(), r = 0; r < E.length; r++)
            if (
              ((n = this._input.match(this.rules[E[r]])), n && (!h || n[0].length > h[0].length))
            ) {
  ...
  Ne = f(async function (e, t, s, a) {
    ...
    try {
      (typeof a.db.getLinks == 'function' ? a.db.getLinks() : new Map()).forEach((m, k) => {
        var I;
        const A =
          typeof k == 'string' ? k : typeof (k == null ? void 0 : k.id) == 'string' ? k.id : '';
        if (!A) {
...
var st = f((e, t, s, a, i, l, d, S) => {
    ...
    if ((D.info('dataFetcher parsedItem', t, T, m), p !== 'root')) {
      ...
      if (
        ...
        e &&
          e.id !== 'root' &&
          (D.trace('Setting node ', p, ' to be child of its parent ', e.id), (L.parentId = e.id)),
        (L.centerLabel = !0),
        t.note)
      ) {
        const I = {
