import { a as gt, g as lt, f as mt, d as xt } from './chunk-OMD6QJNC-BmVXPLUu.js';
import { g as kt } from './chunk-GLLZNHP4-BQKkBBxK.js';
import {
  _ as n,
  h as _t,
  e as vt,
...
import { d as et } from './arc-BLRzZSZJ.js';
var U = (function () {
...
var $ = R().journey,
  ...
  Ht = n(function (t, e, s, c) {
    ...
    let m;
    g === 'sandbox' && (m = H('#i' + e));
    const x = g === 'sandbox' ? H(m.nodes()[0].contentDocument.body) : H('body');
    S.init();
    const h = x.select('#' + e);
    j.initGraphics(h);
  ...
  Xt = n(function (t, e, s) {
    ...
    for (const [h, i] of e.entries()) {
      if (r !== i.section) {
        ((g = X[y % X.length]), (x = y % X.length), (m = st[y % st.length]));
        let l = 0;
        const d = i.section;
