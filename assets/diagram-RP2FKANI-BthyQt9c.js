import { p as k } from './chunk-ANTBXLJU-ZYRP95VF.js';
import {
  _ as l,
  e as R,
  h as I,
...
import { p as W } from './treemap-75Q7IDZK-DMPy7dTl.js';
var m = { showLegend: !0, ticks: 5, max: null, min: 0, graticule: 'circle' },
  w = { axes: [], curves: [], options: m },
  h = structuredClone(w),
  j = z.radar,
  H = l(() => y({ ...j, ...C().radar }), 'getConfig'),
  b = l(() => h.axes, 'getAxes'),
  U = l(() => h.curves, 'getCurves'),
  N = l(() => h.options, 'getOptions'),
  Q = l((a) => {
    h.axes = a.map((t) => ({ name: t.name, label: t.label ?? t.name }));
  }, 'setAxes'),
  X = l((a) => {
    h.curves = a.map((t) => ({ name: t.name, label: t.label ?? t.name, entries: Y(t.entries) }));
  }, 'setCurves'),
  Y = l((a) => {
  ...
  tt = l((a, t, e, r) => {
    ...
    (at(u, o, v, n.ticks, n.graticule),
      rt(u, o, v, c),
      M(u, o, i, x, g, n.graticule, c),
...
var st = { draw: tt },
  ...
  ut = { parser: K, db: $, renderer: st, styles: it };
