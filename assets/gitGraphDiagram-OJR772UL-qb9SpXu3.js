import { p as Z } from './chunk-ANTBXLJU-ZYRP95VF.js';
import { I as F } from './chunk-FHKO5MBM-Cq0OemGn.js';
import {
  _ as h,
  B as U,
  A as rr,
...
import { p as gr } from './treemap-75Q7IDZK-DMPy7dTl.js';
var u = { NORMAL: 0, REVERSE: 1, HIGHLIGHT: 2, MERGE: 3, CHERRY_PICK: 4 },
  yr = $r.gitGraph,
  z = h(() => hr({ ...yr, ...lr().gitGraph }), 'getConfig'),
  i = new F(() => {
    const t = z(),
      r = t.mainBranchName,
      a = t.mainBranchOrder;
...
var xr = h(function (t) {
  ...
  br = h(function (t) {
    ...
    const n = z();
    ((a = E.sanitizeText(a, n)),
      (r = E.sanitizeText(r, n)),
      (e = e == null ? void 0 : e.map((o) => E.sanitizeText(o, n))));
    const c = {
  ...
  mr = h(function (t) {
    let r = t.name;
    const a = t.order;
    if (((r = E.sanitizeText(r, z())), i.records.branches.has(r)))
      throw new Error(
  ...
  wr = h((t) => {
    ...
    const s = t.type,
      e = t.tags,
      n = z();
    ((r = E.sanitizeText(r, n)), a && (a = E.sanitizeText(a, n)));
  ...
  vr = h(function (t) {
    ...
    if (
      ((r = E.sanitizeText(r, n)),
      (a = E.sanitizeText(a, n)),
      (s = s == null ? void 0 : s.map(($) => E.sanitizeText($, n))),
      (e = E.sanitizeText(e, n)),
  ...
  _ = h(function (t) {
    if (((t = E.sanitizeText(t, z())), i.records.branches.has(t))) {
...
var Cr = h(function () {
  ...
  qr = h((t, r) => {
    const s = {
      ...
      Checkout: h((e) => r.checkout(Pr(e)), 'Checkout'),
      CherryPicking: h((e) => r.cherryPick(Hr(e)), 'CherryPicking'),
    }[t.$type];
  ...
  x = 'LR',
  jr = h(() => {
    (C.clear(), B.clear(), G.clear(), (M = 0), (W = []), (x = 'LR'));
  }, 'clear'),
  X = h((t) => {
  ...
  Dr = h((t) => {
    var s;
    const r = J(t.parents.filter((e) => e !== null));
    if (!r) throw new Error(`Closest parent not found for commit ${t.id}`);
    const a = (s = B.get(r)) == null ? void 0 : s.y;
  ...
  Kr = h((t, r) => {
    ...
    const s = a.pos,
      e = r + R;
    return (B.set(t.id, { x: s, y: e }), { x: s, y: e });
  }, 'setCommitPosition'),
  Nr = h((t, r, a) => {
    ...
    if (n === u.HIGHLIGHT)
      ...
      if (
        ...
        (o.attr('cx', a.x),
          o.attr('cy', a.y),
          o.attr('r', 6),
          o.attr('class', `commit ${s} ${r.id} commit${e % O}`));
      }
      n === u.REVERSE &&
        t
          .append('path')
  ...
  Jr = h((t, r, a, s) => {
    ...
    } else return r === 'TB' ? H : r === 'BT' ? (s.get(t.id) ?? e).y - I : 0;
    return 0;
  }, 'calculatePosition'),
  Zr = h((t, r, a) => {
    var c, o;
    ...
    (x === 'BT' && (o && Ar(l, r, n), (l = l.reverse())),
      l.forEach((f) => {
        ...
        if (a) {
          ...
          (_r(s, g, d, p, q, w), Vr(e, g, d, n), Qr(e, g, d, n));
        }
        (x === 'TB' || x === 'BT'
          ? B.set(g.id, { x: d.x, y: d.posWithOffset })
          : B.set(g.id, { x: d.posWithOffset, y: d.y }),
          (n = x === 'BT' && o ? n + I : n + I + R),
          n > M && (M = n));
      }));
  }, 'drawCommits'),
  ...
  Ur = h((t, r, a, s) => {
    ...
    a.type === u.MERGE &&
      r.id !== a.parents[0] &&
      (g = (p = C.get(r.branch)) == null ? void 0 : p.index);
    let d;
    if (c) {
      ((o = 'A 10 10, 0, 0, 0,'), ($ = 'A 10 10, 0, 0, 1,'), (l = 10), (f = 10));
      const T = e.y < n.y ? P(e.y, n.y) : P(n.y, e.y),
        v = e.x < n.x ? P(e.x, n.x) : P(n.x, e.x);
      x === 'TB'
        ? e.x < n.x
  ...
  ee = h((t, r) => {
    ...
    r.forEach((s, e) => {
      ...
      (o.attr('x1', 0),
        ...
        x === 'TB'
          ? (o.attr('y1', H), o.attr('x1', c), o.attr('y2', M), o.attr('x2', c))
          : x === 'BT' && (o.attr('y1', M), o.attr('x1', c), o.attr('y2', H), o.attr('x2', c)),
        W.push(c));
      const $ = s.name,
        l = X($),
        f = a.insert('rect'),
  ...
  te = h(function (t, r, a, s, e) {
    return (
      C.set(t, { pos: r, index: a }),
      (r += 50 + (e ? 40 : 0) + (x === 'TB' || x === 'BT' ? s.width / 2 : 0)),
      r
    );
  }, 'setBranchPosition'),
...
`,
    ...
    (c.forEach((l, f) => {
      ...
      re(o, G),
      K(o, G, !0),
      cr.insertTitle(o, 'gitTitleText', b.titleTopMargin ?? 0, n.getDiagramTitle()),
      ir(void 0, o, b.diagramPadding, b.useMaxWidth));
  }, 'draw'),
  ne = { draw: ae },
  se = h(
    (t) => `
...
`,
  ...
  oe = se,
  le = { parser: Wr, db: Q, renderer: ne, styles: oe };
