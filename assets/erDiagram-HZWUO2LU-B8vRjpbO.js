import { g as Dt } from './chunk-WVR4S24B-CyxjGwcS.js';
import { s as wt } from './chunk-NRVI72HA-BjLFR7Hg.js';
import {
  _ as u,
  j as Lt,
  i as Vt,
...
import { c as Qt } from './channel-C6xf3HoS.js';
var dt = (function () {
  var s = u(function (R, n, a, c) {
    ...
    ct = {
      ...
      table: [
        ...
        { 56: [2, 62] },
        { 21: [1, 75] },
        { 61: 76, 63: V, 64: st, 65: it, 66: rt, 67: nt },
        s(yt, [2, 74]),
        s(yt, [2, 75]),
        ...
        s(i, [2, 12]),
        { 19: [2, 57] },
        s(G, [2, 58], { 54: 94, 55: 95, 57: 96, 59: kt, 60: Et }),
        s([19, 56, 59, 60], [2, 63]),
        ...
        { 19: [1, 105] },
        s(i, [2, 15]),
        s(G, [2, 59], { 55: 106, 58: [1, 107], 60: Et }),
        s(G, [2, 60]),
        s(at, [2, 64]),
        s(G, [2, 67]),
        s(at, [2, 66]),
      ...
      parse: u(function (n) {
        ...
        u(Ot, 'lex');
        for (var g, I, m, ht, C = {}, J, E, At, $; ; ) {
          if (
            ((I = c[c.length - 1]),
            this.defaultActions[I]
              ? (m = this.defaultActions[I])
              : ((g === null || typeof g > 'u') && (g = Ot()), (m = K[I] && K[I][g])),
            typeof m > 'u' || !m.length || !m[0])
          ) {
            var ut = '';
            $ = [];
            for (J in K[I]) this.terminals_[J] && J > xt && $.push("'" + this.terminals_[J] + "'");
            (y.showPosition
              ? (ut =
                  'Parse error on line ' +
                  (H + 1) +
...
Expecting ` +
          ...
          if (m[0] instanceof Array && m.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + I + ', token: ' + g
            );
          switch (m[0]) {
            case 1:
              (c.push(g),
            ...
            case 2:
              if (
                ...
                vt && (C._$.range = [t[t.length - (E || 1)].range[0], t[t.length - 1].range[1]]),
                (ht = this.performAction.apply(C, [e, St, H, x.yy, m[1], p, t].concat(It))),
                typeof ht < 'u')
              )
                return ht;
              (E &&
                ((c = c.slice(0, -1 * E * 2)), (p = p.slice(0, -1 * E)), (t = t.slice(0, -1 * E))),
...
var Ht = u(async function (s, i, h, d) {
    ...
    ((_.type = d.type),
      ...
      (_.diagramId = i),
      await Ut(_, k),
      _.layoutAlgorithm === 'elk' && k.select('.edges').lower());
    const L = k.selectAll('[id*="-background"]');
    Array.from(L).length > 0 &&
      L.each(function () {
        const S = jt(this),
          U = S.attr('id').replace('-background', ''),
          T = k.select(`#${CSS.escape(U)}`);
        if (!T.empty()) {
