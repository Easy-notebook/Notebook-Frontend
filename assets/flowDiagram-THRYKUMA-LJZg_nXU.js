import { g as Ht } from './chunk-GLLZNHP4-BQKkBBxK.js';
import {
  _ as m,
  v as Ot,
  m as t1,
...
import { g as le } from './chunk-WVR4S24B-CyxjGwcS.js';
import { s as ce } from './chunk-NRVI72HA-BjLFR7Hg.js';
import { c as he } from './channel-C6xf3HoS.js';
var de = 'flowchart-',
  P1,
  pe =
    ((P1 = class {
      ...
      addSingleLink(i, a, n, u) {
        ...
        if (
          (b !== void 0 &&
            ...
            (c.labelType = b.type)),
          n !== void 0 &&
            ((c.type = n.type), (c.stroke = n.stroke), (c.length = n.length > 10 ? 10 : n.length)),
...
You have to call mermaid.initialize.`);
        ...
        i.forEach((n) => {
          ...
          n === 'default'
            ...
            : ((this.edges[n].style = a),
              (((o = (u = this.edges[n]) == null ? void 0 : u.style) == null ? void 0 : o.length) ??
                0) > 0 &&
                !(
                  (c = (f = this.edges[n]) == null ? void 0 : f.style) != null &&
                  c.some((k) => (k == null ? void 0 : k.startsWith('fill')))
                ) &&
                ((r = (b = this.edges[n]) == null ? void 0 : b.style) == null ||
                  r.push('fill:none')));
        });
      }
      addClass(i, a) {
      ...
      setClickFun(i, a, n) {
        ...
        if (A1().securityLevel !== 'loose' || a === void 0) return;
        let o = [];
        if (typeof n == 'string') {
          o = n.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
      ...
      addSubGraph(i, a, n) {
        ...
        if (
          ((r = r ?? (k.inheritDir ? (this.getDirection() ?? A1().direction ?? void 0) : void 0)),
          this.version === 'gen-1')
        )
          for (let A = 0; A < b.length; A++) b[A] = this.lookUpDomId(b[A]);
        ((u = u ?? 'subGraph' + this.subCount),
          (o = o || ''),
          (o = this.sanitizeText(o)),
          (this.subCount = this.subCount + 1));
        const E = { id: u, nodes: b, title: o.trim(), classes: [], dir: r, labelType: n.type };
        return (
      ...
      getData() {
        ...
        return (
          b.forEach((r, k) => {
            var d;
            const { arrowTypeStart: E, arrowTypeEnd: A } = this.destructEdgeType(r.type),
              L = [...(b.defaultStyle ?? [])];
            ...
            const C = {
              ...
              curve:
                ...
                ((d = i.flowchart) == null ? void 0 : d.curve),
            };
            n.push(C);
          }),
        ...
        parse: m(function (h) {
          ...
          function Gt() {
            ...
            return (
              (X = l.pop() || U.lex() || Nt),
              typeof X != 'number' &&
                (X instanceof Array && ((l = X), (X = l.pop())), (X = p.symbols_[X] || X)),
              X
            );
          }
          m(Gt, 'lex');
...
Expecting ` +
            ...
            if (Q[0] instanceof Array && Q.length > 1)
              throw new Error(
                'Parse Error: multiple actions possible at state: ' + C1 + ', token: ' + Y
              );
            switch (Q[0]) {
              case 1:
                (g.push(Y),
              ...
              case 2:
                if (
                  ...
                  Kt &&
                    (G1._$.range = [t[t.length - (d1 || 1)].range[0], t[t.length - 1].range[1]]),
...
` +
          ...
          next: m(function () {
            ...
            for (var _ = this._currentRules(), t = 0; t < _.length; t++)
              if (
                ((g = this._input.match(this.rules[_[t]])), g && (!p || g[0].length > p[0].length))
              ) {
