import { G as y } from './graph-f7ir7pXQ.js';
import {
  bf as P,
  aM as w,
  av as f,
...
function Te(e, n, r) {
  for (var t = [], a = n[n.length - 1], o = n[0], i; e.nodeCount(); ) {
    for (; (i = o.dequeue()); ) F(e, n, r, i);
    for (; (i = a.dequeue()); ) F(e, n, r, i);
    if (e.nodeCount()) {
...
function Me(e) {
  var n = e.graph().acyclicer === 'greedy' ? Ce(e, r(e)) : Se(e);
  f(n, function (t) {
    var a = e.edge(t);
    (e.removeEdge(t),
      (a.forwardName = t.name),
      (a.reversed = !0),
      e.setEdge(t.w, t.v, a, q('rev')));
  });
  function r(t) {
    return function (a) {
  ...
  (e.setParent(u, i),
    ...
    f(d, function (l) {
      ...
      var h = e.node(l),
        ...
        b = h.borderTop ? t : 2 * t,
        O = v !== p ? 1 : a - o[i] + 1;
      (e.setEdge(u, v, { weight: b, minlen: O, nestingEdge: !0 }),
        e.setEdge(p, s, { weight: b, minlen: O, nestingEdge: !0 }));
    }),
        ...
        (h || c === s) &&
          (f(o.slice(d, l + 1), function (p) {
            f(e.predecessors(p), function (b) {
              var O = e.node(b),
                H = O.order;
              (H < i || v < H) && !(O.dummy && e.node(p).dummy) && ge(r, b, p);
            });
          }),
          (d = l + 1),
          (i = v));
...
function Mn(e, n) {
  if (e.node(n).dummy)
    return W(e.predecessors(n), function (r) {
...
var Hn = ['nodesep', 'edgesep', 'ranksep', 'marginx', 'marginy'],
  ...
  Kn = ['acyclicer', 'ranker', 'rankdir', 'align'],
  Qn = ['width', 'height'],
  Zn = { width: 0, height: 0 },
...
function tr(e) {
  var n = new y({ multigraph: !0, compound: !0 }),
    r = Y(e.graph());
  return (
    n.setGraph(D({}, Jn, A(r, Hn), C(r, Kn))),
    f(e.nodes(), function (t) {
      var a = Y(e.node(t));
      (n.setNode(t, Ie(A(a, Qn), Zn)), n.setParent(t, e.parent(t)));
    }),
    f(e.edges(), function (t) {
      var a = Y(e.edge(t));
      n.setEdge(t, D({}, nr, A(a, er), C(a, rr)));
    }),
    n
  );
}
