...
import { G as A } from './graph-f7ir7pXQ.js';
import { l as L } from './layout-CB2jlpd8.js';
function N(e) {
  var t = {
  ...
  return (x(e.graph()) || (t.value = F(e.graph())), t);
}
function ee(e) {
...
var f = new Map(),
  ...
  R = X((e, t, n, o) => {
    ...
    (e !== o && c.push(e),
      ...
      c.forEach((a) => {
        if (t.children(a).length > 0) R(a, t, n, o);
        else {
          const r = t.node(a);
  ...
  T = X((e, t) => {
    ...
    let o = [...n];
    for (const c of n) (J.set(c, e), (o = [...o, ...T(c, t)]));
    return o;
  }, 'extractDescendants'),
  ie = X((e, t, n) => {
  ...
  re = X((e, t) => {
    ...
    (e.edges().forEach(function (n) {
      ...
      i.warn('Adjusted Graph', N(e)),
      G(e, 0),
      i.trace(f));
  }, 'adjustClustersAndEdges'),
  G = X((e, t) => {
    var c, a;
    if ((i.warn('extractor - ', t, N(e), e.children('D')), t > 10)) {
      i.error('Bailing out');
      return;
    }
    let n = e.nodes(),
    ...
    for (const r of n)
      if (
        ...
        const v = new A({ multigraph: !0, compound: !0 })
          .setGraph({ rankdir: l, nodesep: 50, ranksep: 50, marginx: 8, marginy: 8 })
          .setDefaultEdgeLabel(function () {
            return {};
          });
        (i.warn('Old graph before copy', N(e)),
          R(r, e, v, r),
          e.setNode(r, {
            clusterNode: !0,
            id: r,
          ...
          i.warn('New graph after copy node: (', r, ')', N(v)),
          i.debug('Old graph after copy', N(e)));
      } else
        (i.warn(
          'Cluster ** ',
          r,
  ...
  j = X(async (e, t, n, o, c, a) => {
    i.warn('Graph in recursive render:XAX', N(t), c);
...
Parent cluster`,
        ...
        if (
          ...
          const p = await j(g, s.graph, n, o, t.node(d), a),
            S = p.elem;
          (Q(s, S),
            (s.diff = p.diff || 0),
            i.info(
      ...
      i.info('Graph before layout:', JSON.stringify(N(t))),
      i.info('############################################# XXX'),
      i.info('###                Layout                 ### XXX'),
      i.info('############################################# XXX'),
      L(t),
      i.info('Graph after layout:', JSON.stringify(N(t))));
    let E = 0,
        ...
        oe(t).map(async function (d) {
          ...
          if (
            ...
            const m = (s == null ? void 0 : s.padding) / 2 || 0,
              p = ((w = s == null ? void 0 : s.labelBBox) == null ? void 0 : w.height) || 0,
              S = p - m || 0;
            (i.debug('OffsetY', S, 'labelHeight', p, 'halfPadding', m),
              await K(l, s),
              (f.get(s.id).node = s));
          } else {
  ...
  le = X(async (e, t) => {
    var a, r, u, l, v, C;
    const n = new A({ multigraph: !0, compound: !0 })
        .setGraph({
          rankdir: e.direction,
          nodesep:
    ...
    (Y(o, e.markers, e.type, e.diagramId),
      ...
      i.warn('Graph at first:', JSON.stringify(N(n))),
      re(n),
      i.warn('Graph after XAX:', JSON.stringify(N(n))));
    const c = U();
