...
import { p as lr } from './chunk-ANTBXLJU-ZYRP95VF.js';
import { p as fr } from './treemap-75Q7IDZK-DMPy7dTl.js';
import { c as Fe } from './cytoscape.esm-BQaXIfA_.js';
var he = { exports: {} },
  le = { exports: {} },
  fe = { exports: {} },
  cr = fe.exports,
        ...
        (function (P, N) {
          ...
          return (function (A) {
            ...
            return (
              ...
              (N.d = function (u, l, a) {
                N.o(u, l) ||
                  Object.defineProperty(u, l, { configurable: !1, enumerable: !0, get: a });
              }),
              (N.n = function (u) {
                var l =
                  u && u.__esModule
              ...
              ((a.prototype.addRoot = function () {
                ...
                (a.prototype.add = function (e, r, f, i, g) {
                  if (f == null && i == null && g == null) {
                    ...
                    if (t == s) return ((f.isInterGraph = !1), t.add(f, i, g));
                    if (
                      ((f.isInterGraph = !0),
                      (f.source = i),
                      (f.target = g),
                ...
                (a.prototype.remove = function (e) {
                  if (e instanceof u) {
                    ...
                    for (var i, g = f.length, t = 0; t < g; t++) ((i = f[t]), r.remove(i));
                    var s = [];
                    s = s.concat(r.getNodes());
                    var o;
                    g = s.length;
                    for (var t = 0; t < g; t++) ((o = s[t]), r.remove(o));
              ...
              ((l.calcSeparationAmount = function (a, e, r, f) {
                ...
                (l.getIntersection2 = function (a, e, r) {
                  var f = a.getCenterX(),
                    ...
                    g = e.getCenterX(),
                    t = e.getCenterY();
                  if (a.intersects(e)) return ((r[0] = f), (r[1] = i), (r[2] = g), (r[3] = t), !0);
                  var s = a.getX(),
                    o = a.getY(),
                    c = a.getRight(),
                    h = a.getX(),
                    ...
                    m = !1;
                  if (f === g) {
                    if (i > t) return ((r[0] = f), (r[1] = o), (r[2] = g), (r[3] = X), !1);
                    if (i < t) return ((r[0] = f), (r[1] = T), (r[2] = g), (r[3] = C), !1);
                  } else if (i === t) {
                    if (f > g) return ((r[0] = s), (r[1] = i), (r[2] = G), (r[3] = t), !1);
                    if (f < g) return ((r[0] = c), (r[1] = i), (r[2] = S), (r[3] = t), !1);
                  } else {
                    ...
                    if (!m)
                      switch (M) {
                        case 1:
                          ((k = C), (x = g + -rt / y), (r[2] = x), (r[3] = k));
                          break;
                        case 2:
                          ((x = Q), (k = t + O * y), (r[2] = x), (r[3] = k));
                          break;
                        case 3:
                          ((k = X), (x = g + rt / y), (r[2] = x), (r[3] = k));
                          break;
                        case 4:
                          ((x = K), (k = t + -O * y), (r[2] = x), (r[3] = k));
                          break;
                      }
                  }
                  return !1;
                ...
                (l.getIntersection = function (a, e, r, f) {
                  ...
                  return (
                    ...
                    Q === 0
                      ? null
                      : ((d = (C * X - G * K) / Q), (v = (S * K - L * X) / Q), new u(d, v))
                  );
                }),
              ...
              ((s.RANDOM_SEED = 1),
                ...
                (s.prototype.createBendpointsFromDummyNodes = function () {
                  ...
                  ((o = o.concat(this.graphManager.getAllEdges())),
                    (o = [].concat(u(this.edgeToDummyNodes.keys())).concat(o)));
            ...
            function (A, P, N) {
              ...
              ((i.prototype.initParameters = function () {
                ...
                (i.prototype.calcIdealEdgeLengths = function () {
                  for (
                    var t, s, o, c, h, T, d, v = this.getGraphManager().getAllEdges(), L = 0;
                    L < v.length;
                    L++
                  )
                    ((t = v[L]),
              ...
              ((u.multMat = function (l, a) {
                ...
                (u.multL = function (l, a, e) {
                  for (var r = [], f = [], i = [], g = 0; g < a[0].length; g++) {
                    for (var t = 0, s = 0; s < a.length; s++) t += -0.5 * a[s][g] * l[s];
                    f[g] = t;
                  }
            ...
            function (A, P, N) {
              ...
              ((u.svd = function (l) {
                ...
                for (
                  ...
                  if (t < i) {
                    this.s[t] = 0;
                    for (var s = t; s < this.m; s++) this.s[t] = u.hypot(this.s[t], l[s][t]);
                    if (this.s[t] !== 0) {
                  ...
                  if (t < g) {
                    ...
                    if (
                      ...
                      for (var G = t + 1; G < this.n; G++)
                        for (var K = t + 1; K < this.m; K++) r[K] += e[G] * l[K][G];
                        ...
                        for (var g = 1; g < this.iMax; g++)
                          for (var t = 1; t < this.jMax; t++) {
                            ...
                            this.sequence1[g - 1] === this.sequence2[t - 1]
                              ...
                              : (s = this.grid[g - 1][t - 1] + this.mismatch_penalty);
                        ...
                        if (o.RELAX_MOVEMENT_ON_CONSTRAINTS)
                            ...
                            this.constraints.relativePlacementConstraint.forEach(function (w) {
                              if (w.left) {
                                var H = M.has(w.left) ? M.get(w.left) : w.left,
                                  B = M.has(w.right) ? M.get(w.right) : w.right;
                                  ...
                                  n.nodesInRelativeHorizontal.includes(B) ||
                                    ...
                                    n.dummyToNodeForVerticalAlignment.has(B)
                                      ? n.nodeToTempPositionMapHorizontal.set(
                                          B,
                                          n.idToNodeMap
                                            .get(n.dummyToNodeForVerticalAlignment.get(B)[0])
                                            .getCenterX()
                                        )
                                      : n.nodeToTempPositionMapHorizontal.set(
                                          B,
                          ...
                          this.constraints.relativePlacementConstraint.forEach(function (w) {
                            if (w.left) {
                              var H = M.has(w.left) ? M.get(w.left) : w.left,
                                B = M.has(w.right) ? M.get(w.right) : w.right;
                              (k.has(H) ? k.get(H).push(B) : k.set(H, [B]),
                                k.has(B) ? k.get(B).push(H) : k.set(B, [H]));
                            } else {
                              var _ = F.has(w.top) ? F.get(w.top) : w.top,
                                ht = F.has(w.bottom) ? F.get(w.bottom) : w.bottom;
                            ...
                            if (this.fixedComponentsOnHorizontal[p])
                              ...
                              for (var k = 0, V = 0, y = 0; y < x.length; y++)
                                if (this.dummyToNodeForVerticalAlignment.has(x[y])) {
                                  ...
                                  ((k += Y.length * this.idToNodeMap.get(Y[0]).displacementX),
                                    (V += Y.length));
                            ...
                            if (this.fixedComponentsOnVertical[p])
                              ...
                              for (var k = 0, V = 0, y = 0; y < x.length; y++)
                                if (this.dummyToNodeForHorizontalAlignment.has(x[y])) {
                                  ...
                                  ((k += Y.length * this.idToNodeMap.get(Y[0]).displacementY),
                                    (V += Y.length));
                    ...
                    (O.prototype.positionNodesRadially = function (n) {
                      for (
                        ...
                        ((m.x = R),
                          ...
                          (R = Math.floor(M.x + o.DEFAULT_COMPONENT_SEPERATION)));
                      }
                  ...
                  ((o.handleConstraints = function (c) {
                      ...
                      if (h.fixedNodeConstraint && h.fixedNodeConstraint.length > 1)
                        (h.fixedNodeConstraint.forEach(function (b, U) {
                          ((E[U] = [b.position.x, b.position.y]),
                            (y[U] = [v[d.get(b.nodeId)], L[d.get(b.nodeId)]]));
                        }),
                          (R = !0));
                        ...
                        (function () {
                          ...
                          if (h.alignmentConstraint.horizontal) {
                            for (
                              var Z = h.alignmentConstraint.horizontal,
                                at = function (tt) {
                                  var j = new Set();
                        ...
                        if (V < x.size / 2) (rt(h.relativePlacementConstraint), (R = !1), (M = !1));
                        else {
                          var z = new Map(),
                            w = new Map(),
                            H = [];
                          ...
                          (k[Y].forEach(function (b, U) {
                            ((y[U] = [v[d.get(b)], L[d.get(b)]]),
                              (E[U] = []),
                              B.has(b) ? (E[U][0] = B.get(b)) : (E[U][0] = v[d.get(b)]),
                    ...
                    if (i.ENFORCE_CONSTRAINTS) {
                      if (h.fixedNodeConstraint && h.fixedNodeConstraint.length > 0) {
                        var Et = { x: 0, y: 0 };
                        (h.fixedNodeConstraint.forEach(function (b, U) {
                          var $ = { x: v[d.get(b.nodeId)], y: L[d.get(b.nodeId)] },
                            J = b.position,
                            Z = X(J, $);
                          ((Et.x += Z.x), (Et.y += Z.y));
                        }),
                ...
                658: (a) => {
                  a.exports =
                    Object.assign != null
                      ...
                      : function (e) {
                          for (
                            var r = arguments.length, f = Array(r > 1 ? r - 1 : 0), i = 1;
                            i < r;
                            i++
                          )
                            f[i - 1] = arguments[i];
                      ...
                      function t(s, o) {
                        ...
                        try {
                          for (
                            ...
                            !(h = (L = v.next()).done) && (c.push(L.value), !(o && c.length === o));
                            h = !0
                          );
                        } catch (S) {
                          ((T = !0), (d = S));
                  ...
                  ((g.getTopMostNodes = function (t) {
                    ...
                    (g.calcBoundingBox = function (t, s, o, c) {
                      for (
                        ...
                        var O = K[Q];
                        ((L = s[c.get(O.id())] - O.width() / 2),
                          (S = s[c.get(O.id())] + O.width() / 2),
                          (C = o[c.get(O.id())] - O.height() / 2),
                          (G = o[c.get(O.id())] + O.height() / 2),
                          h > L && (h = L),
                          T < S && (T = S),
                          d > C && (d = C),
                          v < G && (v = G));
                  ...
                  var f = r(548),
                    ...
                    T = function (v, L) {
                      ...
                      var n = function (x) {
                        ...
                        E = function W(x, k, V, Y) {
                          for (var et = k.length, z = 0; z < et; z++) {
                            ...
                            if (
                              ((B.id = w.data('id')),
                              (B.nodeRepulsion = m(Y.nodeRepulsion, w)),
                              ...
                              Y.nodeDimensionsIncludeLabels &&
                                ((B.labelWidth = w.boundingBox({
                                  includeLabels: !0,
                                  includeNodes: !1,
                                  includeOverlays: !1,
                                }).w),
                                (B.labelHeight = w.boundingBox({
                                  includeLabels: !0,
                                  includeNodes: !1,
                                  includeOverlays: !1,
                                }).h),
                        ...
                        R = function (x, k) {
                          (k.fixedNodeConstraint &&
                            (x.constraints.fixedNodeConstraint = k.fixedNodeConstraint),
                            k.alignmentConstraint &&
                              (x.constraints.alignmentConstraint = k.alignmentConstraint),
                      ...
                      var M = new i(),
                        F = M.newGraphManager();
                      return (
                        E(F.addRoot(), f.getTopMostNodes(G), M, v),
                        y(M, F, K),
                        R(M, v),
                        M.runLayout(),
                        rt
                                ...
                                if (p) {
                                  ...
                                  if (
                                    ...
                                    O.forEach(function (vt, it) {
                                      ((C.eles = vt),
                                        Q.push(h(C, X[it])),
                                        t.relocateComponent(rt[it], Q[it], C));
                                    });
                                  } else
                                    O.forEach(function (vt, it) {
                                  ...
                                  if (
                                    (rt.push({ x: E.x1 + E.w / 2, y: E.y1 + E.h / 2 }), C.randomize)
                                  ) {
                                    var y = o(C);
                                    X.push(y);
                                  }
                      ...
                      var c = o.cy,
                        ...
                        k = function (U) {
                          ...
                          for (var ct = 0; ct < m; ct++)
                            for (var nt = 0; nt < F; nt++) O[ct][nt] *= O[ct][nt];
                          for (var tt = 0; tt < F; tt++) rt[tt] = [];
                          for (var j = 0; j < F; j++)
                            for (var ut = 0; ut < F; ut++) rt[j][ut] = O[X[ut]][j];
                        },
                        V = function () {
                          for (
                            var U = g.svd(rt),
                        ...
                        Y = function () {
                          for (
                            var U = void 0, $ = void 0, J = [], Z = [], at = [], ct = [], nt = 0;
                            nt < m;
                            nt++
                          )
        ...
        if (this.dataStructures === void 0) {
          const D = {},
            A = Object.entries(this.nodes).reduce(
              (e, [r, f]) => (
                (e[r] = f.edges.reduce((i, g) => {
                  var o, c;
                  const t = (o = this.getNode(g.lhsId)) == null ? void 0 : o.in,
                    s = (c = this.getNode(g.rhsId)) == null ? void 0 : c.in;
                  if (t && s && t !== s) {
                    const h = Ar(g.lhsDir, g.rhsDir);
                    h !== 'bend' &&
                      (D[t] ?? (D[t] = {}), (D[t][s] = h), D[s] ?? (D[s] = {}), (D[s][t] = h));
                  }
                  if (g.lhsId === r) {
                    const h = ye(g.lhsDir, g.rhsDir);
                    h && (i[h] = g.rhsId);
                  } else {
                    const h = ye(g.rhsDir, g.lhsDir);
                    h && (i[h] = g.lhsId);
                  }
                  return i;
                }, {})),
            ...
            a = [l(P)];
          for (; Object.keys(u).length > 0; ) a.push(l(Object.keys(u)[0]));
    ...
    await Promise.all(
      D.edges().map(async (e) => {
        ...
        if (
          ...
          c && (Wt(s) ? (S += s === 'L' ? -G : G) : (C += s === 'T' ? -G : G + 18)),
          !g &&
            ((K = A.getNode(r)) == null ? void 0 : K.type) === 'junction' &&
            (Wt(f) ? (T += f === 'L' ? u : -u) : (d += f === 'T' ? u : -u)),
          !c &&
            ((X = A.getNode(t)) == null ? void 0 : X.type) === 'junction' &&
            (Wt(s) ? (S += s === 'L' ? u : -u) : (C += s === 'T' ? u : -u)),
          ...
          if (
            ...
            const O = Wt(f) ? se[f](T, l) : T - a,
              rt = qt(f) ? se[f](d, l) : d - a;
            Q.insert('polygon')
              .attr('points', Ie[f](l))
          ...
          if (o) {
            const O = Wt(s) ? se[s](S, l) : S - a,
              rt = qt(s) ? se[s](C, l) : C - a;
            Q.insert('polygon')
              .attr('points', Ie[s](l))
              .attr('transform', `translate(${O},${rt})`)
              .attr('class', 'arrow');
          ...
          if (h) {
            ...
            if (
              (await me(
                n,
                h,
                { useHtmlLabels: !1, width: rt, classes: 'architecture-service-label' },
                Ee()
              ),
              n
                .attr('dy', '1em')
        ...
        if (r.type === 'group') {
          ...
          if (r.icon) {
            ...
            (h.html(
              ...
              h.attr('transform', 'translate(' + (o + a + 1) + ', ' + (c + a + 1) + ')'),
              (o += N),
              (c += u / 2 - 1 - 2));
          }
          if (r.label) {
            ...
            (await me(
              ...
              h.attr('transform', 'translate(' + (o + a + 4) + ', ' + (c + a + 2) + ')'));
          }
        }
      })
    );
    ...
    for (const N of A) {
      ...
      if (N.title) {
        ...
        (await me(
          f,
          N.title,
          { useHtmlLabels: !1, width: l * 1.5, classes: 'architecture-service-label' },
          P
        ),
          f
            .attr('dy', '1em')
            ...
            .attr('dominant-baseline', 'middle')
            .attr('text-anchor', 'middle'),
          f.attr('transform', 'translate(' + l / 2 + ', ' + l + ')'));
      }
      const a = u.append('g');
      if (N.icon)
        a.html(`<g>${await pe(N.icon, { height: l, width: l, fallbackPrefix: ne.prefix })}</g>`);
      else if (N.iconText) {
        a.html(`<g>${await pe('blank', { height: l, width: l, fallbackPrefix: ne.prefix })}</g>`);
        const g = a
            .append('g')
        ...
        a.append('path')
          .attr('class', 'node-bkg')
          .attr('id', 'node-' + N.id)
          .attr('d', `M0 ${l} v${-l} q0,-5 5,-5 h${l} q5,0 5,5 v${l} H0 Z`);
...
function ze(I, D) {
  const A = [],
    ...
    N = dt((u) => u.split(',').map((l) => parseInt(l)), 'strToPos');
  return (
    I.forEach((u) => {
      const l = Object.fromEntries(Object.entries(u).map(([f, i]) => [P(i), f])),
        a = [P([0, 0])],
        e = {},
        ...
        if (f) {
          ...
          if (i) {
            ...
            Object.entries(r).forEach(([t, s]) => {
              const o = P([g[0] + s[0], g[1] + s[1]]),
                c = l[o];
              c &&
                !e[o] &&
                (a.push(o),
                A.push({ [xe[t]]: c, [xe[mr(t)]]: i, gap: 1.5 * D.getConfigField('iconSize') }));
            });
          }
        }
      }
    ...
    (g.one('layoutstop', () => {
      ...
      function t(o, c, h, T) {
        ...
        const { x: L, y: S } = o,
          { x: C, y: G } = c;
        ((v =
          (T - S + ((L - h) * (S - G)) / (L - C)) / Math.sqrt(1 + Math.pow((S - G) / (L - C), 2))),
          (d = Math.sqrt(Math.pow(T - S, 2) + Math.pow(h - L, 2) - Math.pow(v, 2))));
...
var Pr = dt(async (I, D, A, P) => {
    ...
    const t = f.append('g');
    (t.attr('class', 'architecture-groups'), await Fr(N, g, u), br(N, g, l));
    const s = await Be(u, l, a, e, N, r);
    (await Rr(i, s, N),
      await Sr(t, s, N),
      Xe(N, s),
      qe(void 0, f, N.getConfigField('padding'), N.getConfigField('useMaxWidth')));
  }, 'draw'),
  Gr = { draw: Pr },
  Wr = {
    parser: Ge,
