import { g as fe } from './chunk-GLLZNHP4-BQKkBBxK.js';
import {
  _ as c,
  m as te,
  k as W,
...
var $ = (function () {
  var t = c(function (_, s, n, a) {
    ...
    B = {
      ...
      performAction: c(function (s, n, a, o, u, e, V) {
        var l = e.length - 1;
        switch (u) {
          case 6:
          case 7:
        ...
        for (var k, R, v, Q, F = {}, X, I, oe, K; ; ) {
          if (
            ...
            this.defaultActions[R]
              ...
              : ((k === null || typeof k > 'u') && (k = ae()), (v = V[R] && V[R][k])),
            typeof v > 'u' || !v.length || !v[0])
          ) {
            var Z = '';
            K = [];
            for (X in V[R]) this.terminals_[X] && X > ue && K.push("'" + this.terminals_[X] + "'");
            (b.showPosition
              ? (Z =
                  'Parse error on line ' +
                  (z + 1) +
...
Expecting ` +
          ...
          if (v[0] instanceof Array && v.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + R + ', token: ' + k
            );
          switch (v[0]) {
            case 1:
              (a.push(k),
            ...
            case 2:
              ...
              (I &&
                ...
                u.push(F.$),
                e.push(F._$),
                (oe = V[a[a.length - 2]][a[a.length - 1]]),
                a.push(oe));
              break;
            case 3:
              return !0;
...
` +
  ...
  return (c(O, 'Parser'), (O.prototype = B), (B.Parser = O), new O());
})();
$.parser = $;
var xe = $,
  D = [],
...
` + t
    ...
    Ee(
      ...
      ((B = f.mindmap) == null ? void 0 : B.useMaxWidth) ?? Y.kanban.useMaxWidth
    );
  }, 'draw'),
  Fe = { draw: Ve },
  Ge = c((t) => {
...
`,
  ...
  Ue = Me,
  We = { db: Be, renderer: Fe, parser: xe, styles: Ue };
