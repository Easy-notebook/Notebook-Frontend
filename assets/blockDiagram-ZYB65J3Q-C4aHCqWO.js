import { g as de } from './chunk-GLLZNHP4-BQKkBBxK.js';
import {
  _ as d,
  P as st,
  l as R,
...
import { G as Ee } from './graph-f7ir7pXQ.js';
import { c as _e } from './channel-C6xf3HoS.js';
var wt = (function () {
      ...
      performAction: d(function (x, g, p, w, S, c, _) {
        ...
        switch (S) {
          ...
          case 12:
            ...
            break;
          case 13:
            (w.getLogger().debug('Rule: statement #2: ', c[f - 1]),
              (this.$ = [c[f - 1]].concat(c[f])));
            break;
          case 14:
            (w.getLogger().debug('Rule: link: ', c[f], x),
              (this.$ = { edgeTypeStr: c[f], label: '' }));
            break;
          case 15:
          ...
          case 28:
            ...
            break;
          case 29:
            (w.getLogger().debug('Rule: node (NODE_ID separator): ', c[f]),
              (this.$ = { id: c[f] }));
            break;
          case 30:
            (w
              .getLogger()
              .debug('Rule: node (NODE_ID nodeShapeNLabel separator): ', c[f - 1], c[f]),
              (this.$ = {
                id: c[f - 1],
                label: c[f].label,
                typeStr: c[f].typeStr,
          ...
          case 31:
            ...
            break;
          case 32:
            (w.getLogger().debug('Rule: dirList: ', c[f - 1], c[f]),
              (this.$ = [c[f - 1]].concat(c[f])));
            break;
          case 33:
      ...
      parse: d(function (x) {
        ...
        function Tt() {
          ...
          return (
            (H = w.pop() || M.lex() || P),
            typeof H != 'number' &&
              (H instanceof Array && ((w = H), (H = w.pop())), (H = g.symbols_[H] || H)),
            H
          );
        }
        d(Tt, 'lex');
...
Expecting ` +
          ...
          if (U[0] instanceof Array && U.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + $ + ', token: ' + Y
            );
          switch (U[0]) {
            case 1:
              (p.push(Y),
            ...
            case 2:
              if (
                ...
                return ft;
              (q &&
                ((p = p.slice(0, -1 * q * 2)), (S = S.slice(0, -1 * q)), (c = c.slice(0, -1 * q))),
        ...
        unput: d(function (x) {
          ...
          return (
            (this.yylloc = {
              ...
              last_column: p
                ? (p.length === w.length ? this.yylloc.first_column : 0) +
                  w[w.length - p.length].length -
                  p[0].length
...
` +
        ...
        next: d(function () {
          ...
          for (var S = this._currentRules(), c = 0; c < S.length; c++)
            if (
              ((p = this._input.match(this.rules[S[c]])), p && (!g || p[0].length > g[0].length))
            ) {
        ...
        performAction: d(function (g, p, w, S) {
          switch (w) {
            ...
            case 86:
              return (
                (p.yytext = p.yytext.replace(/^,\s*/, '')),
                g.getLogger().debug('Lex (left):', p.yytext),
                'DIR'
              );
            case 87:
              return (
                (p.yytext = p.yytext.replace(/^,\s*/, '')),
                g.getLogger().debug('Lex (x):', p.yytext),
                'DIR'
              );
            case 88:
              return (
                (p.yytext = p.yytext.replace(/^,\s*/, '')),
                g.getLogger().debug('Lex (y):', p.yytext),
                'DIR'
              );
            case 89:
              return (
                (p.yytext = p.yytext.replace(/^,\s*/, '')),
                g.getLogger().debug('Lex (up):', p.yytext),
                'DIR'
              );
            case 90:
              return (
                (p.yytext = p.yytext.replace(/^,\s*/, '')),
                g.getLogger().debug('Lex (down):', p.yytext),
                'DIR'
              );
            case 91:
              return (
            ...
            case 96:
              return (
                g.getLogger().debug('Lex: START_LINK', p.yytext),
            ...
            case 104:
              return (
                g.getLogger().debug('Lex: COLON', p.yytext),
...
var ke = wt,
  ...
  Ne = z(),
  ot = new Map(),
  Te = d((e) => Le.sanitizeText(e, Ne), 'sanitizeText'),
  Ce = d(function (e, t = '') {
    let a = ot.get(e);
...
function ht(e, t, a = 0, i = 0) {
  ...
  if (((o = e.children) == null ? void 0 : o.length) > 0) {
    ...
    ((l = T.width),
      (s = T.height),
      m.debug('setBlockSizes abc95 maxWidth of', e.id, ':s children is ', l, s));
...
function kt(e, t) {
  ...
  const a = e.columns ?? -1;
  if (
    (m.debug('layoutBlocks columns abc95', e.id, '=>', a, e), e.children && e.children.length > 0)
  ) {
    const x =
...
var dr = d((e, t) => {
  ...
  pr = d(function (e, t, a, i, l, s, r) {
    ...
    (h != null &&
      ...
      a.toCluster &&
        (m.debug('to cluster abc88', i[a.toCluster]),
        (n = zt(a.points, i[a.toCluster].node)),
        (o = !0)),
      a.fromCluster &&
    ...
    const T = e
      ...
      .attr('style', a.style);
    let k = '';
    ((z().flowchart.arrowMarkerAbsolute || z().state.arrowMarkerAbsolute) && (k = we(!0)),
      cr(T, a, k, r, l));
    let N = {};
      ...
      (t.intersect = function (h) {
        ...
        if (
          ...
          (Math.abs(b) < t.width / 2 ||
            (Math.abs(b) == t.width / 2 && Math.abs(y.y - t.y) > t.height / 2 - r))
        ) {
          let L = r * r * (1 - (b * b) / (s * s));
...
var Fr = d(async (e, t) => {
    ...
    (typeof n == 'object' ? (o = n[0]) : (o = n),
      m.info('Label text abc79', o, n, typeof n == 'object'));
  ...
  Yr = d(async (e, t) => {
    ...
    return (
      ...
      (t.intersect = function (u) {
        return (
          m.info('DoubleCircle intersect', t, i.width / 2 + l + s, u),
          C.circle(t, i.width / 2 + l + s, u)
        );
      }),
      a
    );
  ...
  Ur = d(async (e, t) => {
    ...
    if (
      ...
      let c = (h - T.width) / 2;
      (R(v).attr('transform', 'translate( ' + ((-1 * h) / 2 + c) + ', ' + (-1 * y) / 2 + ')'),
        (L = T.height + i));
    }
    let w = (h - x.width) / 2;
    return (
...
function Nt(e, t, a = !1) {
  ...
  const o = ve((i == null ? void 0 : i.styles) ?? []),
    u = i.label,
...
var Vr = d(function (e, t) {
  ...
  ta = { parser: ke, db: Ue, renderer: Zr, styles: Ve };
