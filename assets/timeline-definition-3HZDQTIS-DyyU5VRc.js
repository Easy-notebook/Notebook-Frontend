...
import { d as nt } from './arc-BLRzZSZJ.js';
var X = (function () {
...
Expecting ` +
          ...
          if (I[0] instanceof Array && I.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + H + ', token: ' + w
            );
          switch (I[0]) {
            case 1:
              (h.push(w),
            ...
            case 2:
              if (
                ...
                $ && (z._$.range = [o[o.length - (P || 1)].range[0], o[o.length - 1].range[1]]),
                (K = this.performAction.apply(z, [k, C, M, N.yy, I[1], y, o].concat(O))),
                typeof K < 'u')
              )
                return K;
              (P &&
                ((h = h.slice(0, -1 * P * 2)), (y = y.slice(0, -1 * P)), (o = o.slice(0, -1 * P))),
...
` +
        ...
        next: s(function () {
          ...
          for (var y = this._currentRules(), o = 0; o < y.length; o++)
            if (
              ((h = this._input.match(this.rules[y[o]])), h && (!a || h[0].length > a[0].length))
            ) {
...
var Ft = s(function (n, t, e, l) {
  ...
  Wt = s(function (n, t, e, l) {
    ...
    for (const [L, b] of x.entries()) {
      ...
      (E.debug('taskHeight before draw', R),
        (a = Math.max(a, R + 20)),
        (M = Math.max(M, b.events.length)));
      let A = 0;
...
`,
  ...
  qt = Gt,
  Jt = { db: at, renderer: Ot, parser: Tt, styles: qt };
