import { s as he } from './chunk-NRVI72HA-BjLFR7Hg.js';
import {
  _ as w,
  O as te,
  P as ae,
...
import { p as Ce } from './chunk-ANTBXLJU-ZYRP95VF.js';
import { p as Te } from './treemap-75Q7IDZK-DMPy7dTl.js';
...
function Ue(t, a, l, n, o, s) {
  for (
    ...
    while (!p && b < r);
    for (
      m = N = p, E = Math.max(S / x, x / S) / (v * t), M = p * p * E, V = Math.max(N / M, M / m);
      b < r;
      ++b
    ) {
      if (
    ...
    (d.push((g = { value: p, dice: x < S, children: h.slice(u, b) })),
      g.dice
        ? Xe(g, l, n, o, v ? (n += (S * p) / v) : s)
        : Ye(g, l, n, v ? (l += (x * p) / v) : o, s),
      (v -= p),
      (u = b));
  }
  return d;
...
var Ke = w((t, a) => {
  ...
  at = w((t, a, l, n) => {
    ...
    const V = b
      ...
      ee = Je()
        .size([r, x])
        .paddingTop((e) => (e.children && e.children.length > 0 ? q + B : 0))
        .paddingInner(d)
