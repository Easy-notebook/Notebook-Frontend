...
import { c as ft } from './cytoscape.esm-BQaXIfA_.js';
var tt = { exports: {} },
  et = { exports: {} },
  rt = { exports: {} },
  Ct = rt.exports,
        ...
        (function (D, y) {
          ...
          return (function (u) {
            ...
            return (
              ...
              (y.d = function (r, t, e) {
                y.o(r, t) ||
                  Object.defineProperty(r, t, { configurable: !1, enumerable: !0, get: e });
              }),
              (y.n = function (r) {
                var t =
                  r && r.__esModule
              ...
              ((a.prototype.getEdges = function () {
                ...
                (a.prototype.scatter = function () {
                  ...
                  var T = -i.INITIAL_WORLD_BOUNDARY,
                    m = i.INITIAL_WORLD_BOUNDARY;
                  ((c = i.WORLD_CENTER_Y + o.nextDouble() * (m - T) + T),
                    (this.rect.x = n),
                    (this.rect.y = c));
                }),
                      ...
                      (this.labelWidth > c &&
                        ...
                        this.labelHeight > l &&
                          (this.labelPos == 'center'
                            ...
                            : this.labelPos == 'top' && (this.rect.y -= this.labelHeight - l),
                ...
                (c.prototype.remove = function (E) {
                  ...
                  if (E instanceof o) {
                    ...
                    for (var m = T.edges.slice(), L, O = m.length, d = 0; d < O; d++)
                      ((L = m[d]),
                        L.isInterGraph ? this.graphManager.remove(L) : L.source.owner.remove(L));
              ...
              ((e.prototype.addRoot = function () {
                ...
                (e.prototype.remove = function (i) {
                  if (i instanceof r) {
                    ...
                    if (
                      !(o == this.rootGraph || (o.parent != null && o.parent.graphManager == this))
                    )
                      throw 'Invalid parent node!';
                    var g = [];
                    g = g.concat(o.getEdges());
                    for (var a, v = g.length, n = 0; n < v; n++) ((a = g[n]), o.remove(a));
                    var c = [];
                ...
                (e.prototype.calcLowestCommonAncestors = function () {
                  for (var i, o, g, a, v, n = this.getAllEdges(), c = n.length, l = 0; l < c; l++) {
                    ...
                    for (a = o.getOwner(); i.lca == null; ) {
                      ...
                      i.lca == null &&
                        ((i.sourceInLca = a.getParent()), (a = i.sourceInLca.getOwner()));
                    }
                    if (i.lca == null) throw 'assert failed';
                  }
                }),
            ...
            function (u, D, y) {
              ...
              ((t.calcSeparationAmount = function (e, i, o, g) {
                ...
                var v = Math.abs(
                  (i.getCenterY() - e.getCenterY()) / (i.getCenterX() - e.getCenterX())
                );
                ...
                (t.getIntersection2 = function (e, i, o) {
                  var g = e.getCenterX(),
                    ...
                    v = i.getCenterX(),
                    n = i.getCenterY();
                  if (e.intersects(i)) return ((o[0] = g), (o[1] = a), (o[2] = v), (o[3] = n), !0);
                  var c = e.getX(),
                    l = e.getY(),
                    E = e.getRight(),
                    T = e.getX(),
                    ...
                    G = !1;
                  if (g === v) {
                    if (a > n) return ((o[0] = g), (o[1] = l), (o[2] = v), (o[3] = p), !1);
                    if (a < n) return ((o[0] = g), (o[1] = m), (o[2] = v), (o[3] = s), !1);
                  } else if (a === n) {
                    if (g > v) return ((o[0] = c), (o[1] = a), (o[2] = h), (o[3] = n), !1);
                    if (g < v) return ((o[0] = E), (o[1] = a), (o[2] = N), (o[3] = n), !1);
                  } else {
                    ...
                    if (
                      (g > v
                        ? a > n
                          ? ((S = this.getCardinalDirection(U, w, 4)),
                            (F = this.getCardinalDirection(X, w, 2)))
                          : ((S = this.getCardinalDirection(-U, w, 3)),
                            (F = this.getCardinalDirection(-X, w, 1)))
                        : a > n
                          ? ((S = this.getCardinalDirection(-U, w, 1)),
                            (F = this.getCardinalDirection(-X, w, 3)))
                          : ((S = this.getCardinalDirection(U, w, 2)),
                            (F = this.getCardinalDirection(X, w, 4))),
                      !x)
                    )
                      switch (S) {
                        case 1:
                ...
                (t.getIntersection = function (e, i, o, g) {
                  ...
                  return (
                    ...
                    A === 0
                      ? null
                      : ((L = (s * p - h * f) / A), (O = (N * f - d * p) / A), new r(L, O))
                  );
                }),
                  ...
                  return (
                    r(a, [
                      ...
                      },
                      {
                        ...
                        value: function (n) {
                          if (n <= this.length()) {
                            for (var c = 1, l = this.head; c < n; ) ((l = l.next), c++);
                            return l.value;
                          }
                        },
                      },
                      {
                        ...
                        value: function (n, c) {
                          if (n <= this.length()) {
                            for (var l = 1, E = this.head; l < n; ) ((E = E.next), l++);
                            E.value = c;
                          }
                        },
                      },
              ...
              ((t.lastID = 0),
                (t.createID = function (e) {
                  return t.isPrimitive(e)
                    ? e
                    : (e.uniqueID != null || ((e.uniqueID = t.getString()), t.lastID++),
                      e.uniqueID);
                }),
            ...
            function (u, D, y) {
              function r(l) {
                if (Array.isArray(l)) {
                  for (var E = 0, T = Array(l.length); E < l.length; E++) T[E] = l[E];
                  return T;
              ...
              ((c.RANDOM_SEED = 1),
                ...
                (c.prototype.update2 = function () {
                  if (
                    ...
                    for (var l = this.graphManager.getAllEdges(), E = 0; E < l.length; E++) l[E];
                ...
                (c.prototype.update = function (l) {
                  if (l == null) this.update2();
                    ...
                    var E = l;
                    if (E.getChild() != null)
                      for (var T = E.getChild().getNodes(), m = 0; m < T.length; m++) update(T[m]);
                ...
                (c.prototype.getFlatForest = function () {
                  for (
                    var l = [], E = !0, T = this.graphManager.getRoot().getNodes(), m = !0, L = 0;
                    L < T.length;
                    L++
                  )
                ...
                (c.prototype.createDummyNodesForBendpoints = function (l) {
                  for (
                    var E = [],
                      T = l.source,
                      m = this.graphManager.calcLowestCommonAncestor(l.source, l.target),
                      L = 0;
                  ...
                  return (
                    ...
                    l.isInterGraph() ? this.graphManager.remove(l) : m.remove(l),
                    E
                  );
                }),
            ...
            function (u, D, y) {
              ...
              ((t.prototype.getWorldOrgX = function () {
                ...
                (t.prototype.transformX = function (e) {
                  ...
                  return (
                    o != 0 &&
                      (i = this.ldeviceOrgX + ((e - this.lworldOrgX) * this.ldeviceExtX) / o),
                    i
                  );
                }),
                (t.prototype.transformY = function (e) {
                  ...
                  return (
                    o != 0 &&
                      (i = this.ldeviceOrgY + ((e - this.lworldOrgY) * this.ldeviceExtY) / o),
                    i
                  );
                }),
                (t.prototype.inverseTransformX = function (e) {
                  ...
                  return (
                    o != 0 &&
                      (i = this.lworldOrgX + ((e - this.ldeviceOrgX) * this.lworldExtX) / o),
                    i
                  );
                }),
                (t.prototype.inverseTransformY = function (e) {
                  ...
                  return (
                    o != 0 &&
                      (i = this.lworldOrgY + ((e - this.ldeviceOrgY) * this.lworldExtY) / o),
                    i
                  );
                }),
            ...
            function (u, D, y) {
              function r(n) {
                if (Array.isArray(n)) {
                  for (var c = 0, l = Array(n.length); c < n.length; c++) l[c] = n[c];
                  return l;
              ...
              ((a.prototype.initParameters = function () {
                ...
                (a.prototype.calcIdealEdgeLengths = function () {
                  for (
                    var n, c, l, E, T, m, L = this.getGraphManager().getAllEdges(), O = 0;
                    O < L.length;
                    O++
                  )
                    ((n = L[O]),
                      ...
                      n.isInterGraph &&
                        ...
                        (m = n.getTargetInLca().getEstimatedSize()),
                        this.useSmartIdealEdgeLengthCalculation &&
                          (n.idealLength += T + m - 2 * i.SIMPLE_NODE_SIZE),
                ...
                (a.prototype.calcRepulsionForces = function () {
                  ...
                  if (this.useFRGridVariant)
                    for (
                      this.totalIterations % e.GRID_CALCULATION_CHECK_PERIOD == 1 &&
                        n &&
                        this.updateGrid(),
                        O = new Set(),
                        l = 0;
                ...
                (a.prototype.calcRepulsionForce = function (n, c) {
                  ...
                  if (l.intersects(E)) {
                    ...
                    ((n.repulsionForceX -= p * h),
                      ...
                      (c.repulsionForceY += p * f));
                  } else
                    (this.uniformLeafNodeSizes && n.getChild() == null && c.getChild() == null
                      ? ((L = E.getCenterX() - l.getCenterX()),
                        (O = E.getCenterY() - l.getCenterY()))
                      : (o.getIntersection(l, E, m), (L = m[2] - m[0]), (O = m[3] - m[1])),
                      ...
                      (d = L * L + O * O),
                      (N = Math.sqrt(d)),
                      (s = (this.repulsionConstant * n.noOfChildren * c.noOfChildren) / d),
                      (h = (s * L) / N),
                      (f = (s * O) / N),
                      (n.repulsionForceX -= h),
                      (n.repulsionForceY -= f),
                    ...
                    n.getOwner() == this.graphManager.getRoot()
                      ? ((d = c.getEstimatedSize() * this.gravityRangeFactor),
                        (L > d || O > d) &&
                          ...
                          (n.gravitationForceY = -this.gravityConstant * m)))
                      : ((d = c.getEstimatedSize() * this.compoundGravityRangeFactor),
                        (L > d || O > d) &&
                          ((n.gravitationForceX =
                            -this.gravityConstant * T * this.compoundGravityConstant),
                          (n.gravitationForceY =
                            -this.gravityConstant * m * this.compoundGravityConstant))));
                }),
                (a.prototype.isConverged = function () {
                  ...
                  return (
                    this.totalIterations > this.maxIterations / 3 &&
                      (c = Math.abs(this.totalDisplacement - this.oldTotalDisplacement) < 2),
                ...
                (a.prototype.calcGrid = function (n) {
                  var c = 0,
                    l = 0;
                  ((c = parseInt(Math.ceil((n.getRight() - n.getLeft()) / this.repulsionRange))),
                    (l = parseInt(Math.ceil((n.getBottom() - n.getTop()) / this.repulsionRange))));
                  for (var E = new Array(c), T = 0; T < c; T++) E[T] = new Array(l);
                  for (var T = 0; T < c; T++) for (var m = 0; m < l; m++) E[T][m] = new Array();
                  return E;
                }),
                (a.prototype.addNodeToGrid = function (n, c, l) {
                  var E = 0,
                    ...
                    m = 0,
                    L = 0;
                  ((E = parseInt(Math.floor((n.getRect().x - c) / this.repulsionRange))),
                    (T = parseInt(
                      Math.floor((n.getRect().width + n.getRect().x - c) / this.repulsionRange)
                    )),
                    (m = parseInt(Math.floor((n.getRect().y - l) / this.repulsionRange))),
                    (L = parseInt(
                      Math.floor((n.getRect().height + n.getRect().y - l) / this.repulsionRange)
                    )));
                  for (var O = E; O <= T; O++)
                    for (var d = m; d <= L; d++)
                ...
                (a.prototype.updateGrid = function () {
                  var n,
                    ...
                    l = this.getAllNodes();
                  for (
                    this.grid = this.calcGrid(this.graphManager.getRoot()), n = 0;
                    n < l.length;
                    n++
                  )
                    ((c = l[n]),
                      ...
                      for (var d = n.startY - 1; d < n.finishY + 2; d++)
                        if (!(O < 0 || d < 0 || O >= L.length || d >= L[0].length)) {
                          for (var N = 0; N < L[O][d].length; N++)
                            if (
                              ((m = L[O][d][N]),
                              !(n.getOwner() != m.getOwner() || n == m) && !c.has(m) && !T.has(m))
                            ) {
                              var s =
                                  Math.abs(n.getCenterX() - m.getCenterX()) -
                                  (n.getWidth() / 2 + m.getWidth() / 2),
                                h =
                                  Math.abs(n.getCenterY() - m.getCenterY()) -
                                  (n.getHeight() / 2 + m.getHeight() / 2);
                      ...
                      },
                      {
                        ...
                        value: function (a, v, n) {
                          for (var c = this._get(a, v), l = v, E = n; ; ) {
                            for (; this.compareFunction(c, this._get(a, E)); ) E--;
                            for (; this.compareFunction(this._get(a, l), c); ) l++;
                ...
                return (
                  r(i, [
                    ...
                    },
                    {
                      key: 'getAllIndexes',
                      value: function (g, a) {
                        for (var v = [], n = -1; (n = g.indexOf(a, n + 1)) !== -1; ) v.push(n);
                        return v;
                      },
                    },
                    {
              ...
              ((i.prototype.move = function () {
                ...
                ((this.displacementX =
                  ...
                  Math.abs(this.displacementX) > g.coolingFactor * g.maxNodeDisplacement &&
                    (this.displacementX =
                      g.coolingFactor * g.maxNodeDisplacement * e.sign(this.displacementX)),
                  Math.abs(this.displacementY) > g.coolingFactor * g.maxNodeDisplacement &&
                    (this.displacementY =
                      g.coolingFactor * g.maxNodeDisplacement * e.sign(this.displacementY)),
                  this.child == null
              ...
              ((d.prototype.newGraphManager = function () {
                ...
                (d.prototype.initParameters = function () {
                  (t.prototype.initParameters.call(this, arguments),
                    this.isSubLayout ||
                      ...
                      (this.compoundGravityConstant = v.DEFAULT_COMPOUND_GRAVITY_STRENGTH),
                      (this.gravityRangeFactor = v.DEFAULT_GRAVITY_RANGE_FACTOR),
                      (this.compoundGravityRangeFactor = v.DEFAULT_COMPOUND_GRAVITY_RANGE_FACTOR),
                      (this.prunedNodesAll = []),
                      ...
                      (this.coolingCycle = 0),
                      (this.maxCoolingCycle = this.maxIterations / v.CONVERGENCE_CHECK_PERIOD),
                      (this.finalTemperature = v.CONVERGENCE_CHECK_PERIOD / this.maxIterations),
                  ...
                  if (
                    ...
                    if (a.TREE_REDUCTION_ON_INCREMENTAL) {
                      ...
                      var h = new Set(this.getAllNodes()),
                        f = this.nodesWithGravity.filter(function (I) {
                          return h.has(I);
                        });
                ...
                (d.prototype.getPositionsData = function () {
                  for (var s = this.graphManager.getAllNodes(), h = {}, f = 0; f < s.length; f++) {
                    var p = s[f].rect,
                      A = s[f].id;
                    h[A] = { id: A, x: p.getCenterX(), y: p.getCenterY(), w: p.width, h: p.height };
                  }
                  return h;
                }),
                  ...
                  for (f = 0; f < s.length; f++) {
                    ...
                    if (!h.has(p)) {
                      ...
                      if (A == I)
                        ...
                        var R = [];
                        if (
                          ((R = R.concat(A.getEdgeListToNode(I))),
                          (R = R.concat(I.getEdgeListToNode(A))),
                          !h.has(R[0]))
                        ) {
                          if (R.length > 1) {
                            var x;
                            for (x = 0; x < R.length; x++) {
                              var G = R[x];
                              (G.getBendpoints().push(new l()),
                                this.createDummyNodesForBendpoints(G));
                            }
                          }
                ...
                (d.prototype.positionNodesRadially = function (s) {
                  for (
                    ...
                    x % f == 0 &&
                      ((I = 0), (A = p), x != 0 && (A += a.DEFAULT_COMPONENT_SEPERATION), (p = 0));
                    var G = s[x],
                      U = E.findCenterOfTree(G);
                    ((h.x = I),
                      (h.y = A),
                      (R = d.radialLayout(G, U, h)),
                      R.y > p && (p = Math.floor(R.y)),
                      (I = Math.floor(R.x + a.DEFAULT_COMPONENT_SEPERATION)));
                  }
                ...
                (d.prototype.groupZeroDegreeMembers = function () {
                  ...
                  Object.keys(h).forEach(function (G) {
                    if (h[G].length > 1) {
                      ...
                      var X = h[G][0].getParent(),
                        w = new o(s.graphManager);
                      ((w.id = U),
                        (w.paddingLeft = X.paddingLeft || 0),
                        (w.paddingRight = X.paddingRight || 0),
                        (w.paddingBottom = X.paddingBottom || 0),
                        (w.paddingTop = X.paddingTop || 0),
                        (s.idToDummyNode[U] = w));
                      var S = s.getGraphManager().add(s.newGraph(), w),
                        F = X.getChild();
                      F.add(w);
                ...
                (d.prototype.clearCompounds = function () {
                  ...
                  for (var f = 0; f < this.compoundOrder.length; f++)
                    ((h[this.compoundOrder[f].id] = this.compoundOrder[f]),
                      (s[this.compoundOrder[f].id] = [].concat(
                        this.compoundOrder[f].getChild().getNodes()
                      )),
                ...
                (d.prototype.clearZeroDegreeMembers = function () {
                  ...
                  Object.keys(this.memberGroups).forEach(function (f) {
                    ...
                    ((h[f] = s.tileNodes(s.memberGroups[f], p.paddingLeft + p.paddingRight)),
                      (p.rect.width = h[f].width),
                      (p.rect.height = h[f].height));
                  });
                }),
                ...
                (d.prototype.getToBeTiled = function (s) {
                  ...
                  var f = s.getChild();
                  if (f == null) return ((this.toBeTiled[h] = !1), !1);
                  for (var p = f.getNodes(), A = 0; A < p.length; A++) {
                    var I = p[A];
                    if (this.getNodeDegree(I) > 0) return ((this.toBeTiled[h] = !1), !1);
                    if (I.getChild() == null) {
                      this.toBeTiled[I.id] = !1;
                      continue;
                    }
                    if (!this.getToBeTiled(I)) return ((this.toBeTiled[h] = !1), !1);
                  }
                  ...
                  for (var I = h, R = 0; R < s.rows.length; R++) {
                    ...
                    for (var G = 0, U = 0; U < x.length; U++) {
                      ...
                      ((X.rect.x = h),
                        ...
                        X.rect.height > G && (G = X.rect.height));
                    }
                ...
                (d.prototype.tileNodes = function (s, h) {
                  ...
                  s.sort(function (x, G) {
                    return x.rect.width * x.rect.height > G.rect.width * G.rect.height
                      ? -1
                      : x.rect.width * x.rect.height < G.rect.width * G.rect.height
                        ? 1
                        : 0;
                  });
                  for (var I = 0; I < s.length; I++) {
                    ...
                    (A.rows.length == 0
                      ...
                      : this.canAddHorizontal(A, R.rect.width, R.rect.height)
                        ? this.insertNodeToRow(A, R, this.getShortestRowIndex(A), h)
                ...
                (d.prototype.insertNodeToRow = function (s, h, f, p) {
                  ...
                  var G = 0;
                  (x > s.rowHeight[f] &&
                    ((G = s.rowHeight[f]), (s.rowHeight[f] = x), (G = s.rowHeight[f] - G)),
                    (s.height += G),
                    s.rows[f].push(h));
                }),
                ...
                (d.prototype.canAddHorizontal = function (s, h, f) {
                  ...
                  (s.width - A >= h + s.horizontalPadding
                    ? (R = (s.height + I) / (A + h + s.horizontalPadding))
                    : (R = (s.height + I) / s.width),
                    (I = f + s.verticalPadding));
                  var x;
                  return (
                    s.width < h ? (x = (s.height + I) / h) : (x = (s.height + I) / s.width),
                    x < 1 && (x = 1 / x),
                    R < 1 && (R = 1 / R),
                    R < x
                  );
                ...
                (d.prototype.shiftToLastRow = function (s) {
                  var h = this.getLongestRowIndex(s),
                    ...
                    p = s.rows[h],
                    A = p[p.length - 1],
                    I = A.width + s.horizontalPadding;
                  if (s.width - s.rowWidth[f] > I && h != f) {
                    (p.splice(-1, 1),
                      s.rows[f].push(A),
                      (s.rowWidth[h] = s.rowWidth[h] - I),
                      (s.rowWidth[f] = s.rowWidth[f] + I),
                    ...
                    ((s.rowHeight[h] = R),
                      s.rowHeight[f] < A.height + s.verticalPadding &&
                        (s.rowHeight[f] = A.height + s.verticalPadding));
                    ...
                    for (var I = 0; I < p.length; I++)
                      ((f = p[I]),
                        f.getEdges().length == 1 &&
                          ...
                          f.getChild() == null &&
                          (A.push([f, f.getEdges()[0], f.getOwner()]), (h = !0)));
                    if (h == !0) {
          ...
          return (function (D) {
            ...
            function (D, y, r) {
              ...
              var E = function (L) {
                (L.nodeRepulsion != null &&
                  ...
                  L.idealEdgeLength != null &&
                    (i.DEFAULT_EDGE_LENGTH = e.DEFAULT_EDGE_LENGTH = L.idealEdgeLength),
                  L.edgeElasticity != null &&
                    (i.DEFAULT_SPRING_STRENGTH = e.DEFAULT_SPRING_STRENGTH = L.edgeElasticity),
                  L.nestingFactor != null &&
                    (i.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR = e.PER_LEVEL_IDEAL_EDGE_LENGTH_FACTOR =
                      L.nestingFactor),
                  L.gravity != null &&
                    (i.DEFAULT_GRAVITY_STRENGTH = e.DEFAULT_GRAVITY_STRENGTH = L.gravity),
                  L.numIter != null && (i.MAX_ITERATIONS = e.MAX_ITERATIONS = L.numIter),
                  L.gravityRange != null &&
                    (i.DEFAULT_GRAVITY_RANGE_FACTOR = e.DEFAULT_GRAVITY_RANGE_FACTOR =
                      L.gravityRange),
                  L.gravityCompound != null &&
                    (i.DEFAULT_COMPOUND_GRAVITY_STRENGTH = e.DEFAULT_COMPOUND_GRAVITY_STRENGTH =
                      L.gravityCompound),
              ...
              ((l.prototype.run = function () {
                ...
                ((this.root = s.addRoot()),
                  this.processChildrenList(this.root, this.getTopMostNodes(h), d));
                for (var p = 0; p < f.length; p++) {
                  var A = f[p],
                    I = this.idToLNode[A.data('source')],
                  ...
                  U = function X() {
                    ...
                    if (F) {
                      (d.checkLayoutSuccess() && !d.isSubLayout && d.doPostLayout(),
                        ...
                        N.options.eles.nodes().positions(G),
                        w(),
                ...
                return (
                  ...
                  this.options.animate !== 'during' &&
                    (N.options.eles.nodes().not(':parent').layoutPositions(N, N.options, G),
                    (m = !1)),
                  this
                );
              }),
                (l.prototype.getTopMostNodes = function (m) {
                  for (var L = {}, O = 0; O < m.length; O++) L[m[O].id()] = !0;
                  ...
                  for (var d = L.length, N = 0; N < d; N++) {
                    ...
                    if (
                      (s.outerWidth() != null && s.outerHeight() != null
                        ...
                        : (f = m.add(new g(this.graphManager))),
                      (f.id = s.data('id')),
                      ...
                      var A = s.boundingBox({ includeLabels: !0, includeNodes: !1 }).w,
                        I = s.boundingBox({ includeLabels: !0, includeNodes: !1 }).h,
                        R = s.css('text-halign');
                    ...
                    if (
                      ...
                      var x;
                      ((x = O.getGraphManager().add(O.newGraph(), f)),
...
var at = (function () {
  var C = _(function (O, d, N, s) {
    ...
    T = {
      ...
      performAction: _(function (d, N, s, h, f, p, A) {
        var I = p.length - 1;
        switch (f) {
          case 6:
          case 7:
          ...
          case 12:
            ...
            break;
          case 15:
            (h.getLogger().info('Node: ', p[I].id),
              h.addNode(p[I - 1].length, p[I].id, p[I].descr, p[I].type));
            break;
          case 16:
          ...
          case 20:
            ...
            break;
          case 25:
            (h.getLogger().trace('node found ..', p[I - 2]),
              (this.$ = { id: p[I - 1], descr: p[I - 1], type: h.getType(p[I - 2], p[I]) }));
            break;
          case 26:
            this.$ = { id: p[I], descr: p[I], type: h.nodeType.DEFAULT };
            break;
          case 27:
            (h.getLogger().trace('node found ..', p[I - 3]),
              (this.$ = { id: p[I - 3], descr: p[I - 1], type: h.getType(p[I - 2], p[I]) }));
            break;
        }
      }, 'anonymous'),
      table: [
        { 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: M },
        { 1: [3] },
        { 1: [2, 1] },
        { 4: 6, 6: [1, 7], 7: [1, 8], 8: M },
        {
        ...
        C(i, [2, 4]),
        C(i, [2, 5]),
        { 1: [2, 6], 6: u, 12: 21, 13: D, 14: 14, 15: y, 16: r, 17: 17, 18: 18, 19: t, 22: e },
        { 6: u, 9: 22, 12: 11, 13: D, 14: 14, 15: y, 16: r, 17: 17, 18: 18, 19: t, 22: e },
        { 6: o, 7: g, 10: 23, 11: a },
        C(v, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: t, 22: e }),
        C(v, [2, 18]),
        C(v, [2, 19]),
        C(v, [2, 20]),
        C(v, [2, 21]),
        ...
        { 20: [1, 31] },
        { 6: o, 7: g, 10: 32, 11: a },
        { 1: [2, 7], 6: u, 12: 21, 13: D, 14: 14, 15: y, 16: r, 17: 17, 18: 18, 19: t, 22: e },
        C(n, [2, 14], { 7: c, 11: l }),
        C(E, [2, 8]),
        C(E, [2, 9]),
        C(E, [2, 10]),
      ...
      parse: _(function (d) {
        ...
        function H() {
          ...
          return (
            (W = h.pop() || w.lex() || U),
            typeof W != 'number' &&
              (W instanceof Array && ((h = W), (W = h.pop())), (W = N.symbols_[W] || W)),
            W
          );
        }
        _(H, 'lex');
        for (var P, B, $, j, V = {}, z, Z, lt, q; ; ) {
          if (
            ((B = s[s.length - 1]),
            ...
            var nt = '';
            q = [];
            for (z in A[B]) this.terminals_[z] && z > G && q.push("'" + this.terminals_[z] + "'");
            (w.showPosition
              ? (nt =
                  'Parse error on line ' +
                  (R + 1) +
...
Expecting ` +
          ...
          if ($[0] instanceof Array && $.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + B + ', token: ' + P
            );
          switch ($[0]) {
            case 1:
              (s.push(P),
            ...
            case 2:
              if (
                ...
                (j = this.performAction.apply(V, [I, x, R, S.yy, $[1], f, p].concat(X))),
                typeof j < 'u')
              )
                return j;
              (Z &&
                ((s = s.slice(0, -1 * Z * 2)), (f = f.slice(0, -1 * Z)), (p = p.slice(0, -1 * Z))),
...
` +
        ...
        next: _(function () {
          ...
          for (var f = this._currentRules(), p = 0; p < f.length; p++)
            if (
              ((s = this._input.match(this.rules[f[p]])), s && (!N || s[0].length > N[0].length))
            ) {
              if (((N = s), (h = p), this.options.backtrack_lexer)) {
                if (((d = this.test_match(s, f[p])), d !== !1)) return d;
                if (this._backtrack) {
                  N = !1;
                  continue;
                } else return !1;
          ...
          return N
            ? ((d = this.test_match(N, f[h])), d !== !1 ? d : !1)
            : this._input === ''
              ? this.EOF
              : this.parseError(
                  'Lexical error on line ' +
...
` +
        ...
        performAction: _(function (N, s, h, f) {
          switch (h) {
            case 0:
...
var Ft = at,
  ...
  Ut =
    ((K = class {
      ...
      getParent(M) {
        for (let u = this.nodes.length - 1; u >= 0; u--)
          if (this.nodes[u].level < M) return this.nodes[u];
        return null;
      }
      getMindmap() {
      ...
      addNode(M, u, D, y) {
        ...
        const r = st();
        let t = ((o = r.mindmap) == null ? void 0 : o.padding) ?? it.mindmap.padding;
        switch (y) {
        ...
        const e = {
            ...
            type: y,
            children: [],
            width: ((g = r.mindmap) == null ? void 0 : g.maxNodeWidth) ?? it.mindmap.maxNodeWidth,
            padding: t,
          },
          i = this.getParent(M);
    ...
    K),
  Pt = 12,
  Yt = _(function (C, M, u, D) {
    (M.append('path')
      .attr('id', 'node-' + u.id)
      .attr('class', 'node-bkg node-' + C.type2Str(u.type))
      .attr(
        'd',
        `M0 ${u.height - 5} v${-u.height + 10} q0,-5 5,-5 h${u.width - 10} q5,0 5,5 v${u.height - 5} H0 Z`
      ),
      M.append('line')
        .attr('class', 'node-line-' + D)
        .attr('x1', 0)
        .attr('y1', u.height)
        .attr('x2', u.width)
        .attr('y2', u.height));
...
function pt(C, M, u, D, y) {
  return C.insert('polygon', ':first-child')
    .attr(
      'points',
      D.map(function (r) {
        return r.x + ',' + r.y;
...
var Bt = _(function (C, M, u) {
  ...
  Vt = _(async function (C, M, u, D, y) {
    ...
    let i = 'section-' + t;
    (t < 0 && (i += ' section-root'),
      e.attr('class', (u.class ? u.class + ' ' : '') + 'mindmap-node ' + i));
    const o = e.append('g'),
      g = e.append('g'),
      a = u.descr.replace(
        /(<br\/*>)/g,
...
`
    ...
    (await At(g, a, { useHtmlLabels: r, width: u.width, classes: 'mindmap-node-label' }, y),
      r ||
        g
          .attr('dy', '1em')
    ...
    const v = g.node().getBBox(),
      [n] = It(y.fontSize);
    if (
      ((u.height = v.height + n * 1.1 * 0.5 + u.padding),
      (u.width = v.width + 2 * u.padding),
      u.icon)
    )
      ...
      const c = (u.width - v.width) / 2,
        l = (u.height - v.height) / 2;
    ...
    switch (u.type) {
      ...
      case C.nodeType.CIRCLE:
        (o.attr('transform', 'translate(' + u.width / 2 + ', ' + +u.height / 2 + ')'),
          $t(C, o, u, t));
        break;
...
async function ot(C, M, u, D, y) {
  (await Vt(C, M, u, D, y),
    u.children && (await Promise.all(u.children.map((r, t) => ot(C, M, r, D < 0 ? t : D, y)))));
}
_(ot, 'drawNodes');
function dt(C, M) {
  M.edges().map((u, D) => {
...
function vt(C, M) {
  return new Promise((u) => {
    const D = Ot('body').append('div').attr('id', 'cy').attr('style', 'display:none'),
      y = ft({
...
function yt(C, M) {
  M.nodes().map((u, D) => {
    ...
    (Q.info('id:', D, 'Position: (', u.position().x, ', ', u.position().y, ')', y),
      r.attr(
        'transform',
...
` + C
  ...
  zt = _((C) => {
    ...
    for (let u = 0; u < C.THEME_COLOR_LIMIT; u++)
      ((C['lineColor' + u] = C['lineColor' + u] || C['cScaleInv' + u]),
        Nt(C['lineColor' + u])
          ? (C['lineColor' + u] = mt(C['lineColor' + u], 20))
          : (C['lineColor' + u] = Dt(C['lineColor' + u], 20)));
    for (let u = 0; u < C.THEME_COLOR_LIMIT; u++) {
      const D = '' + (17 - 3 * u);
      M += `
