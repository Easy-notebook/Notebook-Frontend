        ...
        <div className="relative bg-white rounded-xl shadow-xl">
          ...
          {input && (
            <div className="max-h-60 overflow-y-auto p-3 border-t border-gray-100">
              {input.startsWith('/') ? (
                <div className="p-2 text-base text-gray-600">Executing command mode...</div>
              ) : (
                <div className="p-2 text-base text-gray-600">Asking question mode...</div>
              )}
            </div>
          )}
