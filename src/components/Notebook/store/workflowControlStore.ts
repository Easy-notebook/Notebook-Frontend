...
export const useWorkflowControlStore = create<WorkflowControlState>((set) => ({
  ...
  setContinueCountdown: (continueCountdown) =>
    set((state) => {
  ...
  setIsReturnVisit: (isReturnVisit) =>
    set((state) => {
  ...
  setDynamicWorkflow: (dynamicWorkflow) =>
    set((state) => {
  ...
  setCurrentChapterActions: (currentChapterActions) =>
    set((state) => {
  ...
  setOnCancelCountdown: (onCancelCountdown) =>
    set((state) => {
