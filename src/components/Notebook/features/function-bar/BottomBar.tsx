    ...
    >
      ...
      <div className="flex items-center justify-between h-8 text-theme-800">
        <style>{`
                ...
                `}</style>
        <div
          className="flex items-left space-x-3 text-xs font-medium infoBar"
          ...
          <div className="h-[calc(100%-1.75rem)] text-gray-800 overflow-y-auto scrollbar-thin">
            ...
            {currentTab === 'output' && (
              <div className="p-2">
                ...
                <p className="text-xs mt-0.5">
                  <span className="text-theme-800 font-medium">62.5 KB</span>{' '}
                  <span className="text-gray-600">build/static/js/main.chunk.js</span>
                </p>
                <p className="text-xs">
                  <span className="text-theme-800 font-medium">28.1 KB</span>{' '}
                  <span className="text-gray-600">build/static/js/0.chunk.js</span>
                </p>
                <p className="text-xs">
                  <span className="text-theme-800 font-medium">16.2 KB</span>{' '}
                  <span className="text-gray-600">build/static/css/main.chunk.css</span>
                </p>
              </div>
            )}
            {currentTab === 'debug' && (
