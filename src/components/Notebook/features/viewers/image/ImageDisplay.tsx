// moved to features/viewers/image
...
const ImageDisplay: React.FC<ImageDisplayProps> = memo(
  ({
    ...
    const [imgHeight, setImgHeight] = useState<string | number | undefined>(
      imageInitialHeight === null ? undefined : imageInitialHeight
    );
      ...
      return (
        ...
        >
          <div className="text-center text-gray-400">
            {/* 空状态图标 */}
            <svg
              className="w-14 h-14 mx-auto text-gray-300"
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            ...
            <div className="absolute inset-0 flex items-center justify-center bg-white bg-opacity-95">
              <div className="text-center text-gray-600 max-w-xs">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  There was a problem displaying this image. Please try again.
                </p>
              </div>
            </div>
          ) : (
                ...
                <>
                  ...
                  >
                    <img
                      ...
                      className={`rounded-md max-w-none transition-opacity duration-500 ${
