...
const ProblemDefineWorkload: FC<ProblemDefineProps> = ({ confirmProblem }) => {
  ...
  const handleProblemSelect = useCallback(
    (problem: ProblemChoice) => {
      ...
      setSelectedProblemStore(problem.target, problem.problem_description, problem.problem_name);
      setStep('background');
    },
          ...
          <div className="max-w-4xl mx-auto px-4 py-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                {t('emptyState.fileUploaded') || '文件已上传'}:{' '}
            ...
            <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-2xl p-6">
              ...
              <div className="flex gap-3">
                <input
                  ...
                  placeholder={
                    t('emptyState.customProblemPlaceholder') || '描述你想进行的自定义分析...'
                  }
            ...
            <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 mb-6">
              <textarea
                ...
                onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
                  setDatasetBackground(e.target.value)
                }
                placeholder={
                  t('emptyState.backgroundPlaceholder') ||
                  '请描述数据集的背景信息、数据来源、收集目的等...'
                }
        ...
        <div className="w-full max-w-2xl mx-auto px-4 py-16 text-center">
          ...
          <div className="max-w-2xl mx-auto px-4 py-8 animate-in fade-in slide-in-from-left-4 duration-500">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">{t('emptyState.reviewSettings') || '请检查以下设置'}</p>
            </div>

            <div className="bg-white border-2 border-gray-200 rounded-2xl p-6 mb-8 space-y-4">
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">
                  {t('emptyState.analysisType') || '分析类型'}
                </h4>
              ...
              {datasetBackground && (
                <div>
                  <h4 className="font-semibold text-gray-800 mb-2">
                    {t('emptyState.datasetBackground') || '数据集背景'}
                  </h4>
